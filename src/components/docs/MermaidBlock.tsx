...
function readThemeVariables() {
  ...
  const fg = cssVar("--app-fg", "#e6f4f1");
  const muted = cssVar("--app-fg-muted", "#8aada6");
  const elevated = cssVar("--app-bg-elevated", "#10242c");
  const subtle = cssVar("--app-bg-subtle", "#17333c");
  const bg = cssVar("--app-bg", "#07161c");
  const border = cssVar("--app-border", "#21444c");
  const accent = cssVar("--app-accent", "#2fd3b6");
  return {
    darkMode: theme === "dark",
    background: elevated,
