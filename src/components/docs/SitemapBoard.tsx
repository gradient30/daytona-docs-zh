...
import { useOfficialMap } from "@/lib/docs/use-official-map";
  ...
  return (
    <div className="mt-8 max-w-5xl" data-sitemap-board data-docs-open={docsOpen}>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <Card label="公开手册" value={`${officialCount} 页`} hint="www.daytona.io/docs" />
        <Card
          label="手册待办"
      ...
      <p className="mt-4 text-xs text-fg-subtle" data-map-source={state.source}>
        底稿指纹来自官网 Markdown。每日 Action 对照 sitemap 后会更新本表。
      </p>
