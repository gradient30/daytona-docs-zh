...
Audit logs are available to [administrators](/docs/organizations#roles) with full access and [members](/docs/organizations#roles) with audit log permissions. Contact your organization administrator to get access to audit logs.
...
| **`target输入`** | string | Resource type affected (e.g., `sandbox`, `snapshot`) |
...
## 获取组织审计日志 {#get-audit-logs-for-organization}
...
> 英文原文：https://www.daytona.io/docs/en/audit-logs
> 本站位置：`/docs/audit-logs`
