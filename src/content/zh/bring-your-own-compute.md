...
Daytona provides two [built-in regions](/docs/regions) (**US** and **EU**) for shared compute resources and handling provisioning, maintenance, monitoring, and scaling on your behalf.
...
### 创建自定义区域 {#create-a-custom-region}
...
### 更新自定义区域 {#update-a-custom-region}
...
### 删除自定义区域 {#delete-a-custom-region}
...
> 英文原文：https://www.daytona.io/docs/en/bring-your-own-compute
> 本站位置：`/docs/bring-your-own-compute`
