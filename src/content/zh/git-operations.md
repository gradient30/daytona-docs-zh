...
### Checkout branches or commits {#checkout-branches-or-commits}
...
Daytona provides additional Git operations through the [Toolbox API](/docs/tools/api#daytona-toolbox).
...
> 英文原文：https://www.daytona.io/docs/en/git-operations
> 本站位置：`/docs/git-operations`
