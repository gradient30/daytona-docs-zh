# AG2 缺陷修复智能体 {#ag2-bug-fixer-agent}

用 AG2 在 Daytona 沙箱里修 bug。
...
#### AG2 ConversableAgent {#ag2-conversableagent}
...
#### DaytonaCodeExecutor {#daytonacodeexecutor}
...
#### Step 1: Imports and environment {#step-1-imports-and-environment}
...
#### Step 2: Bug fixer system prompt {#step-2-bug-fixer-system-prompt}
...
#### Step 3: Create the agents {#step-3-create-the-agents}
...
#### Step 4: Start the conversation {#step-4-start-the-conversation}
...
#### How the message loop works {#how-the-message-loop-works}
...
> 英文原文：https://www.daytona.io/docs/en/guides/ag2/ag2-bug-fixer-agent
> 本站位置：`/docs/guides/ag2/ag2-bug-fixer-agent`
