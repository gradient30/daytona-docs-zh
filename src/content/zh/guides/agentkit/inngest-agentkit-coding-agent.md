# Inngest AgentKit 编程智能体 {#inngest-agentkit-coding-agent}

AgentKit + Daytona 编码工作流。
...
### 5. 理解智能体执行流 {#5-understanding-the-agent-s-execution-flow}
...
#### Create Components & Update App 结构 {#create-components-update-app-structure}
...
#### Check Dev Server Health {#check-dev-server-health}
...
#### App Summary & 特性 {#app-summary-features}
...
> 英文原文：https://www.daytona.io/docs/en/guides/agentkit/inngest-agentkit-coding-agent
> 本站位置：`/docs/guides/agentkit/inngest-agentkit-coding-agent`
