# Claude Code 跑任务并流式日志 {#claude-code-run-tasks-stream-logs-sandbox}
...
## 在 Daytona 沙箱里跑 Claude Code {#running-claude-code-in-a-daytona-sandbox}
...
> 英文原文：https://www.daytona.io/docs/en/guides/claude/claude-code-run-tasks-stream-logs-sandbox
> 本站位置：`/docs/guides/claude/claude-code-run-tasks-stream-logs-sandbox`
