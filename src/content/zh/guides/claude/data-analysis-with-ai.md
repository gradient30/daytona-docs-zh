# 用 AI 做数据分析 {#data-analysis-with-ai}
...
## 用 Daytona 构建 AI 数据分析师 {#build-an-ai-data-analyst-with-daytona}
...
#### 1.2 Configure Environment {#1-2-configure-environment}
...
### 2. 数据集准备 {#2-dataset-preparation}

#### 2.1 下载数据集 {#2-1-download-dataset}
...
#### 2.2 Initialize Sandbox {#2-2-initialize-sandbox}

Now create a [Daytona sandbox](/docs/sandboxes#create-sandboxes) and upload your dataset:
...
#### 3.2 Creating the Analysis Prompt {#3-2-creating-the-analysis-prompt}
...
#### 3.3 Tool Definition {#3-3-tool-definition}
...
#### 3.4 Agentic Loop Implementation {#3-4-agentic-loop-implementation}
...
### 4. 运行分析 {#4-running-your-analysis}
...
### 5. 完整实现 {#5-complete-implementation}
...
> 英文原文：https://www.daytona.io/docs/en/guides/claude/data-analysis-with-ai
> 本站位置：`/docs/guides/claude/data-analysis-with-ai`
