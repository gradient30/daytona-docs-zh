# Devin CLI 跑任务并流式日志 {#devin-cli-run-tasks-stream-logs-sandbox}
...
> 英文原文：https://www.daytona.io/docs/en/guides/devin/devin-cli-run-tasks-stream-logs-sandbox
> 本站位置：`/docs/guides/devin/devin-cli-run-tasks-stream-logs-sandbox`
