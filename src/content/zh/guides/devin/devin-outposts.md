...
### What Outposts changes {#what-outposts-changes}
...
#### Build the sandbox snapshot {#build-the-sandbox-snapshot}
...
2. Create a sandbox named `devin-` from `SNAPSHOT_NAME`, or restart the existing one when the session is waking from sleep.
...
- [Run the Devin CLI in a Daytona sandbox](/docs/guides/devin/devin-cli-run-tasks-stream-logs-sandbox)
- [Daytona documentation](https://www.daytona.io/docs/index.md)

> 英文原文：https://www.daytona.io/docs/en/guides/devin/devin-outposts
> 本站位置：`/docs/guides/devin/devin-outposts`
