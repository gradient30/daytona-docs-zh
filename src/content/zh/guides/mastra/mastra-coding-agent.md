# Mastra 编程智能体 {#mastra-coding-agent}

Mastra coding agent + Daytona。

This guide demonstrates how to configure the [Mastra coding agent](https://github.com/mastra-ai/template-coding-agent) to use Daytona sandboxes, enabling you to leverage AI capabilities for any coding-related task in a secure, 隔离环境.
...
> 英文原文：https://www.daytona.io/docs/en/guides/mastra/mastra-coding-agent
> 本站位置：`/docs/guides/mastra/mastra-coding-agent`
