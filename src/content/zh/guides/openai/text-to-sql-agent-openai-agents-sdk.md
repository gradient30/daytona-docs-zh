# Text-to-SQL 智能体 {#text-to-sql-agent-openai-agents-sdk}

OpenAI Agents SDK + SQL。
...
The agent also runs on any OpenAI-compatible provider such as [Fireworks AI](https://fireworks.ai/) - see [Using a Different Model Provider](/docs/guides/openai/openai-agents-sdk-with-sandboxes#using-a-different-model-provider) for the model configuration.
...
## 3\. The SqlCapability {#3-the-sqlcapability}
...
## 5\. The Conversation Loop {#5-the-conversation-loop}
...
## 7\. Downloadable Results via Exposed Ports {#7-downloadable-results-via-exposed-ports}
...
## 8\. Memory Across Sessions {#8-memory-across-sessions}
...
> 英文原文：https://www.daytona.io/docs/en/guides/openai/text-to-sql-agent-openai-agents-sdk
> 本站位置：`/docs/guides/openai/text-to-sql-agent-openai-agents-sdk`
