# OpenCode SDK 智能体 {#opencode-sdk-agent}
...
The agent can develop full-stack web apps, write code in any language, install dependencies, and run scripts. It can also start and manage dev servers, and generate [preview links](/docs/preview) for live apps.
...
When your task involves running or previewing a web application, the agent can host the app and generate a [preview link](/docs/preview) for you to inspect the live result:
...
> 英文原文：https://www.daytona.io/docs/en/guides/opencode/opencode-sdk-agent
> 本站位置：`/docs/guides/opencode/opencode-sdk-agent`
