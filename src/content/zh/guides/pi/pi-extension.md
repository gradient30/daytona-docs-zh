...
### 3. Understanding the Extension Architecture {#3-understanding-the-extension-architecture}
...
| **Git & GitHub** | GitHub authorization with `gh`, and `/merge` via the GitHub API | Git 操作 (clone and push) via the [Daytona git API](/docs/git-operations) |
...
#### 1. Tool registration {#1-tool-registration}
...
#### 2. Session start {#2-session-start}
...
#### 4. GitHub branch sync {#4-github-branch-sync}
...
> 英文原文：https://www.daytona.io/docs/en/guides/pi/pi-extension
> 本站位置：`/docs/guides/pi/pi-extension`
