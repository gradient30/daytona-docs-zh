# HUD RL Cookbook {#hud-rl-cookbook}
...
### 1. What we're building {#1-what-we-re-building}
...
### 4. Ship it to Daytona {#4-ship-it-to-daytona}
...
Forking is available on Daytona's [VM Sandboxes](/docs/sandboxes).

### 7. Train on the rollouts you just graded {#7-train-on-the-rollouts-you-just-graded}
...
#### 配置 reference {#configuration-reference}
...
> 英文原文：https://www.daytona.io/docs/en/guides/reinforcement-learning/hud-rl-cookbook
> 本站位置：`/docs/guides/reinforcement-learning/hud-rl-cookbook`
