# TRL GRPO 训练 {#trl-grpo-training}

TRL GRPO 在 Daytona 上训练。
...
#### How Prompts Become Completions {#how-prompts-become-completions}
...
#### Banned Pattern Detection {#banned-pattern-detection}
...
#### Parallel Batch Evaluation {#parallel-batch-evaluation}
...
#### Training 配置 {#training-configuration}
...
### 5. Example Evaluation Walkthrough {#5-example-evaluation-walkthrough}
...
### 7. Adding Custom Tasks {#7-adding-custom-tasks}
...
- **Safe execution**: Generated code runs in 隔离环境s, protecting your system
...
> 英文原文：https://www.daytona.io/docs/en/guides/reinforcement-learning/trl-grpo-training
> 本站位置：`/docs/guides/reinforcement-learning/trl-grpo-training`
