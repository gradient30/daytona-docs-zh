# veRL ReTool {#verl-retool-daytona}
...
### 2. The Problem: Tool Execution Bottlenecks Rollout Speed {#2-the-problem-tool-execution-bottlenecks-rollout-speed}
...
### 3. Daytona as the ReTool Backend {#3-daytona-as-the-retool-backend}
...
#### Clone veRL and Initialize the Recipe Submodule {#clone-verl-and-initialize-the-recipe-submodule}
...
#### Download the Model Checkpoint {#download-the-model-checkpoint}
...
#### Export the Daytona API Key {#export-the-daytona-api-key}
...
> 英文原文：https://www.daytona.io/docs/en/guides/reinforcement-learning/verl-retool-daytona
> 本站位置：`/docs/guides/reinforcement-learning/verl-retool-daytona`
