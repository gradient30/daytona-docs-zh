...
## Update network settings while a sandbox is running {#update-network-settings-while-a-sandbox-is-running}
...
## Network allow list format {#network-allow-list-format}
...
## Domain allow list format {#domain-allow-list-format}
...
### NPM registry and package managers {#npm-registry-and-package-managers}
...
### Git hosting and version control {#git-hosting-and-version-control}
...
### Elixir/Erlang packages {#elixir-erlang-packages}
...
### Ubuntu/Debian package repositories {#ubuntu-debian-package-repositories}
...
### CDN and content delivery {#cdn-and-content-delivery}
...
### Docker registries and container services {#docker-registries-and-container-services}
...
### Scientific and ML downloads {#scientific-and-ml-downloads}
...
> 英文原文：https://www.daytona.io/docs/en/network-limits
> 本站位置：`/docs/network-limits`
