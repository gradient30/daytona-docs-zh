...
tip
Port `22222` is used by the [web terminal](/docs/web-terminal) to access the terminal using preview URLs.
...
- Upgrade to [Tier 3](/docs/limits)
- Deploy a [custom preview proxy](/docs/custom-preview-proxy)

> 英文原文：https://www.daytona.io/docs/en/preview
> 本站位置：`/docs/preview`
