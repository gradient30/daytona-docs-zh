...
## 连接 PTY 会话 {#connect-to-pty-session}
...
## 获取 PTY 会话信息 {#get-pty-session-info}
...
## Kill PTY session {#kill-pty-session}
...
## Resize PTY session {#resize-pty-session}
...
## PtyHandle methods {#ptyhandle-methods}
...
### Resize from handle {#resize-from-handle}
...
### Exit code and error {#exit-code-and-error}
...
### Iterate over output (Python) {#iterate-over-output-python}
...
> 英文原文：https://www.daytona.io/docs/en/pty
> 本站位置：`/docs/pty`
