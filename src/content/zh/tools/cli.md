...
| `--version` | `-v` | 显示 the version of Daytona |
...
| `--volume` | `-v` | 卷 to mount (format: VOLUME_ID_OR_NAME:MOUNT_PATH) |
| `--help` |  | help for daytona |
...
## daytona organization members {#daytona-organization-members}
...
## daytona snapshot activate {#daytona-snapshot-activate}
Activate a snapshot
...
> 英文原文：https://www.daytona.io/docs/en/tools/cli
> 本站位置：`/docs/tools/cli`
