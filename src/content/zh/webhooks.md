...
## 访问 Webhooks {#accessing-webhooks}
...
## 创建 Webhook 端点 {#create-webhook-endpoints}
...
## 编辑 Webhook 端点 {#edit-webhook-endpoints}
...
## 删除 Webhook 端点 {#delete-webhook-endpoints}
...
## Webhook 载荷格式 {#webhook-payload-format}
...
### **`sandbox.state.updated`** {#sandbox-state-updated}
...
### **`snapshot.state.updated`** {#snapshot-state-updated}
...
### **`volume.state.updated`** {#volume-state-updated}
...
> 英文原文：https://www.daytona.io/docs/en/webhooks
> 本站位置：`/docs/webhooks`
